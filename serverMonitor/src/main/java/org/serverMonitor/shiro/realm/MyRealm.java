...
import org.serverMonitor.service.UserService;
...
//        return null;  
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {  
        ...
        if(null!=user){
        	SimpleAuthenticationInfo authocInfo = new SimpleAuthenticationInfo(user.getUsername(), user.getPassword(),user.getUsername()+user.getPassword());
        	this.setSession(user.getUsername(), user);
        	return authocInfo;  
        }
        else{
        	return null;
